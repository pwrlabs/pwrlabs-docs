    ...
    const sections = [
        {
            ...
            img: (
                <BlockSvg 
                    style={{
                        '--svg-stroke': colorMode === 'dark' ? '#FFFFFF' : '#1E1F31'
                    }}
                />
            ),
        },
