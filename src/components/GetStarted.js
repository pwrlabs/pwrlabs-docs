...
export default () => {
    ...
    const sections = [
        ...
        {
            title: "Build a VIDAs",
            description: "Find everything you need to build a VIDAs with PWR Chain.",
            link: "/developers/how-to-build-a-vida/basics-of-blockchain-development",
            img: (
