...
export default () => {
    ...
    const projects = [
        ...
        },
        {
            ...
            img: (
                <svg width="38" height="38" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M32.499 23.7546V19.3796C32.499 17.8878 31.9064 16.4571 30.8515 15.4022C29.7966 14.3473 28.3659 13.7546 26.874 13.7546H24.374C23.8767 13.7546 23.3998 13.5571 23.0482 13.2055C22.6966 12.8538 22.499 12.3769 22.499 11.8796V9.37964C22.499 7.8878 21.9064 6.45706 20.8515 5.40216C19.7966 4.34727 18.3659 3.75464 16.874 3.75464H13.749M13.749 25.0046H26.249M13.749 30.0046H19.999M17.499 3.75464H9.37402C8.33902 3.75464 7.49902 4.59464 7.49902 5.62964V34.3796C7.49902 35.4146 8.33902 36.2546 9.37402 36.2546H30.624C31.659 36.2546 32.499 35.4146 32.499 34.3796V18.7546C32.499 14.7764 30.9187 10.9611 28.1056 8.14804C25.2926 5.33499 21.4773 3.75464 17.499 3.75464Z" stroke={colorMode === "dark" ? "#FFFFFF" : "#1E1F31"} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
            )
        },
        {
